...
function build_loss(args,dzdt_rhs,dzdt_sens_rhs,encoder, decoder, par_encoder,par_decoder,u0_train)    
    ...
    function loss_(in_batch,dx_batch,par_batch,dxda_batch,dtdxda_batch)
        tdim = args["tsize"]
        n_ = args["x_dim"]
        p_ = args["par_dim"]
        loss_AE_state = 0.0f0
