...
include("/home/kaliam/NormalFormAE/problems/pf.jl")
...
model_z = NormalForm(:pf,z_dim ,par_dim, dzdt_rhs, dzdt_solve)
...
nfae = NFAE(:toy, :pf, model_x, model_z, training_size, test_size, state, par, nothing, tscale_init,
...
# Hepfers, should go into nfae at some point
loss_train_full = []
loss_test_full = []
last_loss = 1e10
loss_test = 0.0f0
